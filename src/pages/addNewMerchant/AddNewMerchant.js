...
export default function AddNewMerchant() {
    ...
    const formik = useFormik({
        ...
        validationSchema: runnerRegistrationValidationSchema,
    ...
    return (
        <>
            <Paper sx={{ flexGrow: 1 }} elevation={10} style={paper}>
                <Navbar title={'Add New Merchant'} backButtonPath={`/admin/operator/${condo}/shop-and-food`} />
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div>
                        ...
                        <div className='displayFlexRow'>
                            ...
                            <FormLabel htmlFor='runnersBoss' className='headingOfRadioButoonAndLable' >Who supply delivvery runner?</FormLabel>
                        ...
                        {toggle
                            ...
                            <div>
                                ...
                                {formik.touched.merchantName && formik.errors.merchantName ? <Alert severity="warning">{formik.errors.merchantName}</Alert> : null}
