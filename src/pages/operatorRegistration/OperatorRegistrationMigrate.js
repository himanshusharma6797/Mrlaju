...
import operatorRegMigValidationSchema from '../../validations/operatorRegMigValidationSchema';
...
export default function OperatorRegistration() {
    ...
    const formik = useFormik({
        ...
        // {
        //     "id": 1,
        //     "groupType": "Joint Management Body",
        //     "residentGroupName": "Operator migrate 2",
        //     "email": "op2m@gmaiaal.com",
        //     "fileUrl": "ww.googlsffse.com",
        //     "propertyCount": 1,
        //     "status": "MIGRATED",
        //     "reason": "NOt valid person",
        //     "isMigrate": true,
        //     "prevEmail": "",
        //     "prevMobileNumber": "",
        //     "prevResidentGroupName": "",
        //     "prevFileUrl": "",
        //     "address": {
        //         "id": 1,
        //         "unitNumber": "00-Cop5",
        ...
        //         "id": 1,
        //         "bankName": "New Bank",
        //         "accountHolderName": "Hitu",
        //         "accountNumber": "34657346588"
        //     }
        // }
        ...
        validationSchema: operatorRegMigValidationSchema,
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            setisDisable(true)
            const response = await authAxios.put('operator/update', values)
            notify()
            setTimeout(() => {
                setisDisable(false)
                navigate("/")
        ...
        <>
            <Paper sx={{ flexGrow: 1 }} className="OperatorRegNew" elevation={10} style={{ padding: '1.25rem' }}>
                ...
                <ButtonGroup className="doubleButton" sx={{ marginBottom: '1rem', alignItems: 'center' }}>
                    <Button className='doubleButtonSmallMigrate' onClick={() => navigateToAnyWhere('/operator-registration/new-account')}>New Account</Button>
                    <Button className='doubleButtonBigMigrate' onClick={() => navigateToAnyWhere('/operator-registration/migrate-account')}>Migrated Account</Button>
                </ButtonGroup>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <label className="loginLable" htmlFor="mobileNumber">Previous mobile number for this account</label>
                    ...
                    <input id="propertyCount" className="loginInputs" variant="standard"
