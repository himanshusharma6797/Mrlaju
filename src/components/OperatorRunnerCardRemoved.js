...
export default function OperatorRunnerCardRemoved(props) {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >Residence: {props.resident}</Typography>
                    <Box sx={{
                        display: 'flex',
                        justifyContent: 'space-between',
                        width: '100%',
                ...
                <Button
                    onClick={() => changeStatusOfRunner(props.id, "APPROVED")}
                    className="removeBtnOperatorRunner fontSize12px approveBtnGreen" variant="contained">Approve</Button>
            </Box>
        </>
    )
}
